...
middle_val = 0.5
min_val = 0
/*var myColor = d3.scaleSequential().domain([min_val,max_val])
...
/*LECTURE DU FICHIER DEPARTEMENTS CONTENANT LES CHEMINS DES CONTOURS*/
		d3.json("departements.json", function(json) {
			...
			d3.csv("hosp_indice.csv", function(data_jour){
...
var w = 320, h = 50;
    ...
    legend.append("stop")
      .attr("offset", "0%")
      .attr("stop-color", myColor(1))
      .attr("stop-opacity", 1);

    legend.append("stop")
      .attr("offset", "16%")
      .attr("stop-color", myColor(0.83))
      .attr("stop-opacity", 1);

    legend.append("stop")
      .attr("offset", "33%")
      .attr("stop-color", myColor(0.67))
      .attr("stop-opacity", 1);

    legend.append("stop")
      .attr("offset", "49%")
      .attr("stop-color", myColor(0.49))
      .attr("stop-opacity", 1);

    legend.append("stop")
      .attr("offset", "67%")
      .attr("stop-color", myColor(0.33))
      .attr("stop-opacity", 1);

    legend.append("stop")
      .attr("offset", "83%")
      .attr("stop-color", myColor(0.16))
      .attr("stop-opacity", 1);
    ...
    d3.select(".legend1").append("div")
    	.attr("class","legend_c")
    	.text("Nouveaux Hospitalisés / Total Hospitalisés (%)");
