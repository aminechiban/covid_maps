...
console.log(myColor(0.03));
console.log(myColor(0.06));
console.log(myColor(0.09));
console.log(myColor(0.12));
console.log(myColor(0.15));
console.log(myColor(0.17));
console.log("Fin");
...
/*LECTURE DU FICHIER DEPARTEMENTS CONTENANT LES CHEMINS DES CONTOURS*/
		d3.json("departements.json", function(json) {
			...
			d3.csv("hosp_pop.csv", function(data_jour){
...
var w = 320, h = 50;
    ...
    d3.select(".legend1").append("div")
    	.attr("class","legend_c")
    	.text("Nbr Hospitalisés / Population (%)");
